...
export function Navbar(){
    ...
    return (
        <div className="w-[200px] min-h-[calc(100vh-80px)] rounded-tr-2xl bg-white p-[20px]">
            <ul>
                <li>
                    <NavLink to='/dashboard' onClick={() => setOpenMenu(null)} className={({isActive}) => `w-full flex gap-[8px] px-[12px] py-[10px] cursor-pointer rounded-2xl transition-all duration-200 ${isActive ? "bg-gray-100" : ''}`}><GridViewRoundedIcon /> <p>대시보드</p></NavLink>
                </li>
                <li>
